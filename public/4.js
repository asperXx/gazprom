  ...
  data: function data() {
    return {
      items: [{
        ...
        'name': 'Скидка на обед',
        'price': 20,
        'pic': 'https://avtozakony.ru/wp-content/uploads/2016/11/skidka-50-procentov1.jpg',
        'desc': "Description of bla bla and bla"
      }, {
        'id': 1,
        'name': 'Скидка на обед',
        'price': 20,
...
// module
exports.push([module.i, "\n.card[data-v-e1ea323e] {position: relative;}\n.text[data-v-e1ea323e] {color: #fff !important}\n.button[data-v-e1ea323e] {margin: 0 auto}\n.pic[data-v-e1ea323e] {display:block; position: relative; box-sizing: border-box; width:100%; height:200px; background-size: contain; background-position: center center;}\n.desc_wrap[data-v-e1ea323e] {height: 50px; position: relative; overflow: hidden;}\n", ""]);
    ...
    [
      ...
      _c(
        ...
        _vm._l(_vm.items, function(item, id) {
          return _c(
            "v-col",
            { key: id, attrs: { cols: "12", sm: "6", md: "4", lg: "3" } },
            [
              _c(
                "v-card",
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "v-btn",
                        { staticClass: "button", attrs: { color: "#0D356C" } },
                        [
